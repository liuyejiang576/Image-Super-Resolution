#!/usr/bin/env python3
"""Run MobileSRNet-Plus fair-budget 20k training.

Called by plus_20k.py resume. Do not start manually unless debugging.

  python scripts/run_plus_20k.py --skip-done
"""
...
MANIFEST = PROJECT_ROOT / "results/exp_runs/plus_20k_manifest.json"
...
def main() -> None:
    ...
    print("MobileSRNet-Plus 20k — training")
