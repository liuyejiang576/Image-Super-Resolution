#!/usr/bin/env python3
"""Run B5a P0 plain3x3 fair-budget 20k training.

Called by b5a_20k.py resume. Default trains abl_plain3x3_c16n10_20k only.

  python scripts/run_b5a_20k.py --skip-done
"""
...
MANIFEST = PROJECT_ROOT / "results/exp_runs/b5a_20k_manifest.json"
...
DEFAULT_RUN_IDS = ["abl_plain3x3_c16n10_20k"]
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--run-id",
        default=None,
        help="Train one run_id. Default: P0 plain3x3 only.",
    )
    p.add_argument(
        "--all-gated",
        action="store_true",
...
def main() -> None:
    ...
    print("\nB5a P0 train complete. Next: eval + ablation_b5a_p0.json (phone = graph-identity only).")
