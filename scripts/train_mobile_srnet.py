#!/usr/bin/env python3
"""Train MobileSRNet on DIV2K with periodic validation."""
...
from models import MobileSRNet  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser()
    parser.add_argument("--config", default="configs/train_mobile_srnet.yaml")
...
def build_model(data_cfg: dict, model_cfg: dict) -> MobileSRNet:
    return MobileSRNet(
