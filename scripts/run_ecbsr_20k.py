#!/usr/bin/env python3
"""Run ECBSR-M10C16 fair-budget 20k training.

Called by ecbsr_20k.py resume. Do not start manually unless debugging.

  python scripts/run_ecbsr_20k.py --skip-done
"""
...
MANIFEST = PROJECT_ROOT / "results/exp_runs/ecbsr_20k_manifest.json"
LOG_DIR = PROJECT_ROOT / "results/exp_runs/logs"
TRAIN_SCRIPT = PROJECT_ROOT / "scripts/train_ecbsr.py"
...
def main() -> None:
    ...
    print("ECBSR-M10C16 20k — training")
    ...
    print("\nECBSR 20k complete. Next: fuse_ecbsr → NCNN + phone bench (B3).")
